const JOBS = [
  {
    period: "12.06.2023 – PRESENT",
    title: "SOFTWARE ENGINEER (.NET)",
    company: "Romsoft SRL",
    description: "Back-end developer specializing in the architecture and implementation of a license-based digital product platform. Responsible for designing secure RESTful APIs, integrating license key generation and validation logic, managing relational databases (MySQL), and implementing user authentication and role-based access control. Ensures scalable, efficient server-side logic using .Net (c#), with a focus on system security and performance. For nearly a year, I have implemented CI/CD automation using Azure Pipelines and integrated a range of Azure services, including Web Apps, Function Apps, Storage Accounts, SQL Server, SQL Databases, and Service Bus for robust message handling and system integration. Integrated Azure cloud services with third-party solutions to streamline system functionality and scalability."
  },
  {
    period: "29.08.2022 – 09.06.2023",
